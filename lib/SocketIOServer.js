...
var configureSimpleServers = function ( http, serverPort, serverCreators){
    ...
    if (serverCreators === undefined) {
        serverCreators = [];
    }
    
    serverCreators = serverCreators.concat(createServer);
    var sensorsServer = new sensorsio.SensorsServer.Server(http, serverPort, serverCreators)
